  ...
  handleSubmit(event) {
    ...
    if(this.state.playlistName === '')
    {
      ...
      this.setState({ response: this.state.playlistName + " is what I would of choosen too!",
                      response1: "Now Send " + this.state.playlistName + " to Spotify"});
    }
  }
       ...
       <div style={shown2} > 
        <div style={shown1a}>   
                      <div style={ shown1 }>
                              ...
                              <div style={ hidden }>
                                  <div className="nameChoose"> Everyone knows a good playlist has a good name <span>🚫🧢</span> </div> 
            ...
            <div style={hidden1a}>
            <div className="nameChoose"> Looks like you don't have any liked Tracks </div>
                    <div className="nameChoose1"> That's okay! Create a custom playlist based on genres</div> 
                    <form onSubmit={this.handleSubmit1}><br/><br/>
                          <div className="genreList"><label>hip-hop<span>💯</span><input name="rap" type="checkbox" checked={this.state.hiphop} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList"><label> Rock<span>🗿 </span><input name="rock" type="checkbox" checked={this.state.rock} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList"><label> Reggae<span>✌</span> <input name="reggae" type="checkbox" checked={this.state.reggae} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList"><label> Pop<span>🎵</span> <input name="pop" type="checkbox" checked={this.state.pop} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList"><label> Metal<span>🤘🏽</span> <input name="metal" type="checkbox" checked={this.state.metal} onChange={this.handleInputChange}/></label></div><br/><br/><br/>
                          <div className="genreList1"><label> Country<span>🤠</span> <input name="country" type="checkbox" checked={this.state.country} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList1"><label> Electronic<span>🤖</span> <input name="electronic" type="checkbox" checked={this.state.electronic} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList1"><label> Disco<span>💿</span> <input name="disco" type="checkbox" checked={this.state.disco} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList1"><label> Funk<span>🕺</span> <input name="funk" type="checkbox" checked={this.state.funk} onChange={this.handleInputChange}/></label></div>
                          <div className="genreList1"><label> dance<span>💃</span> <input name="dance" type="checkbox" checked={this.state.dance} onChange={this.handleInputChange}/></label></div>
          ...
          <div style={hidden2}> 
                ...
                <div className="nameChoose1"> Click as many times as you want...We wont judge <span>🤫</span></div>
          ...
          <div className="txtTitle1"> WELCOME TO GENESIS </div>
              ...
              <div className="txtbody1">    Genesis will gather data from your current Spotify account and determine which music type best
                                            suits you. Genesis will generate a playlist based on your current Liked Tracks. After the new playlist 
                                            has been created, Genesis will redirect you to Spotify where you can enjoy the new music! </div>
                            
                          <div className="txtbody2"> When you <span>👍</span> tracks on Spotify, Genesis will automatically update accordingly to generate 
                            your perfect playlist giving you new music that is customized to you. </div>

                            
                <center><button onClick={this.handleButtonClick} class="chooseSubmit4"> Roger That <span>👌</span></button></center>
          ...
          <TabPanel>
              ...
              <div className="faqTxtBody"> - Genesis will automatically detect if you have NOT liked any tracks.<br/><br/>
               <b>In the case that you have not liked any tracks:</b><br/>Genesis will prompt you to select your favorite genres and will
               create a custom playlist based on the genres selected. <br/><br/>
               <b>In the case that you have liked tracks:</b><br/> Genesis will analyze your liked tracks and create a playlist based on 
                related tracks.</div>
               <br/><br/>
              ...
              <center><button onClick={this.handleButtonClick} class="chooseSubmit7"> Roger That <span>👌</span></button></center>
          </TabPanel>
